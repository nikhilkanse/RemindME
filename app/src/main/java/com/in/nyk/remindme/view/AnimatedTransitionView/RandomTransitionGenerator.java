...
public class RandomTransitionGenerator implements TransitionGenerator {
    ...
    public Transition generateNextTransition(RectF drawableBounds, RectF viewport) {
        ...
        if (!firstTransition) {
            ...
            viewportRatioChanged = !MathsUtil.haveSameAspectRatio(dstRect, viewport);
        }
    ...
    private RectF generateRandomRect(RectF drawableBounds, RectF viewportRect) {
        float drawableRatio = MathsUtil.getRectRatio(drawableBounds);
        float viewportRectRatio = MathsUtil.getRectRatio(viewportRect);
        RectF maxCrop;
        ...
        float randomFloat = MathsUtil.truncate(mRandom.nextFloat(), 2);
